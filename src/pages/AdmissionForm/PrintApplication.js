...
const PrintApplication = () => {
    ...
    const handlePrint = async () => {
        ...
        // Write the updated form HTML with embedded images and page breaks into the new window
        ...
        // Add content from each page, including page breaks
        pages.forEach((page, index) => {
            let pageContent = '';

            // Loop through each table on the current page and add its content
            page.forEach(tableId => {
                const table = document.getElementById(tableId);
                if (table) {
                    pageContent += table.outerHTML; // Append the HTML of the table
                }
            });

            // Add the page content to the print window
            printWindow.document.write(`
                <div class="printable">
                    ${pageContent}
                </div>
        ...
        // Finish the document in the print window and trigger the print dialog
        printWindow.document.write(`
                </body>
            </html>
        `);
        ...
        setTimeout(() => {
            printWindow.document.close();  // Necessary for the print dialog to open
