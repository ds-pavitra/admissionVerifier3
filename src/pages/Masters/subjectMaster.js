    ...
    const fetchCourses = useCallback(async () => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                const sortedCourses = response.result.sort((a, b) => a.name.localeCompare(b.name));
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs title="Subject Management" breadcrumbItems={breadcrumbItems} />
