                            ...
                            <Col xl={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <Row>
                                            <Col md={6}>
                                                <img className="rounded me-2" alt="Cubicle HRMS" width="200" src={img4} />
                                            </Col>
                                            <Col md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    <img className="rounded-circle avatar-xl" alt="Cubicle HRMS" src={avatar4} />
                                                </div>
                                            </Col>
                                        </Row>
                                    </CardBody>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <Row>
                                            <Col md={6}>
                                                <img className="img-thumbnail" alt="Cubicle HRMS" width="200" src={img3} />
                                            </Col>
                                            <Col md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    <img className="img-thumbnail rounded-circle avatar-xl" alt="Cubicle HRMS" src={avatar3} />
                                                </div>
                                            </Col>
                                        </Row>
                                    </CardBody>
                            ...
                            <Col xl={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardImg className="img-fluid" src={img2} alt="Cubicle HRMS" />
                                    </CardBody>
                                </Card>
                            </Col>
                                    ...
                                    <CardBody>
                                        ...
                                        <Row>
                                            <Col md={6}>
                                                <Row>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar3} alt="Cubicle HRMS" className="rounded avatar-sm" />
                                                        <CardText className="mt-2 mb-lg-0"><code>.avatar-sm</code></CardText>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar4} alt="Cubicle HRMS" className="rounded avatar-md" />
                                                        <CardText className="mt-2  mb-lg-0"><code>.avatar-md</code></CardText>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar5} alt="Cubicle HRMS" className="rounded avatar-lg" />
                                            ...
                                            <Col md={6}>
                                                <Row>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar3} alt="Cubicle HRMS" className="rounded-circle avatar-sm" />
                                                        <CardText className="mt-2 mb-lg-0"><code>.avatar-sm</code></CardText>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar4} alt="Cubicle HRMS" className="rounded-circle avatar-md" />
                                                        <CardText className="mt-2  mb-lg-0"><code>.avatar-md</code></CardText>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar5} alt="Cubicle HRMS" className="rounded-circle avatar-lg" />
                                                        <CardText className="mt-2 mb-lg-0"><code>.avatar-lg</code></CardText>
                                                    </Col>
                                                </Row>
                                            </Col>
